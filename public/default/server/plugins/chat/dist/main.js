        ...
        function (e, t, s) {
            function r(e, t) {
                for (var s = 0; s < e.length; s++) {
                    ...
                    if (i) {
                        ...
                        for (; o < r.parts.length; o++) i.parts.push(a(r.parts[o], t))
                    } else {
                        for (var n = [], o = 0; o < r.parts.length; o++) n.push(a(r.parts[o], t));
                        d[r.id] = {
                            id: r.id,
                            refs: 1,
                            parts: n
            ...
            function c(e, t) {
                var s = t.css,
                    r = t.media;
                t.sourceMap;
                if (r && e.setAttribute("media", r), e.styleSheet) e.styleSheet.cssText = s;
                else {
