...
CREATE TABLE `fixture_company` (
  ...
  `vipmechanismid` int(11) DEFAULT '1' COMMENT '会员机制id，默认 免费版',
  ...
  `deadline` datetime DEFAULT NULL COMMENT '机制过期时间，过期后自动成为免费版（后台自动定期处理）',
...
CREATE TABLE `fixture_conf_vipfunctionpoint` (
   ...
   `text` varchar(255) DEFAULT NULL COMMENT '免费版value',
...
CREATE TABLE `fixture_filter_role` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='过滤 - 角色';
...
CREATE TABLE `fixture_log_vipupgrade` (
  ...
  `uuid` char(32) DEFAULT NULL COMMENT '唯一索引',
  `companyid` int(11) DEFAULT NULL COMMENT '公司id',
  `vipmechanismid` int(11) DEFAULT NULL COMMENT '会员机制id，默认 免费版',
