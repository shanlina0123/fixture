...
class AdminController extends ServerBaseController
{
    ...
    public  function  getListData()
    {
        ...
        $list=$this->admin_business->index($user->isadmin,$user->companyid,$user->cityid,$user->storeid,$user->islook,$page,$data);
    ...
    public  function  store()
    {
        ...
        //执行业务处理
        $this->admin_business->store($user->companyid,$user->cityid,$user->wechatopenid,$data);
        //接口返回结果
