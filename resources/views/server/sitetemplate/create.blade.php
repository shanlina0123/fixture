...
@section('content')
    ...
    <form class="layui-form" id="layui-form" method="post" action="{{route('site-template.store')}}">
        {{csrf_field()}}
        <div class="layui-form-item">
            <label class="layui-form-label">模板名称</label>
            <div class="layui-input-inline" style="width:25%;">
                <input type="text"  name="name"  value="{{old('name')}}" class="layui-input" placeholder="请输入模板名称" datatype="*2-10"  nullmsg="请输入模板名称" errormsg="模板名称为2-10位字符">
            </div>
        </div>
        <div id="tagList">
            <div class="layui-form-item">
