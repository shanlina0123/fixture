...
<div class="main">
    <div class="toppart clearfix">
        @if( $data && $data->head_img && $data->status == 0 )
            <img src="{{$data->head_img}}" class="leftimg fl" width="101" height="101">
        @else
            <img src="{{pix_asset('server/images/wx.png')}}" class="leftimg fl" >
        @endif
        <div class="righttext fl">
            <div class="topname">小程序名称：{{$data && $data->status == 0?$data->nick_name:'小程序'}}</div>
