...
return [
   ...
   // "showUploads"=>$_SERVER["REQUEST_SCHEME"]."://".$_SERVER["SERVER_NAME"].":".$_SERVER["SERVER_PORT"]."/uploads",//图片预览路径
    ...
    "cssVersion"=>"V1.0.1.1_201807231110",//strtotime(date("Y-m-d H:i:s")),//css版本
    "jsVersion"=>"V1.0.1.1_201807231110",//strtotime(date("Y-m-d H:i:s")),//js版本
    ...
    "emails"=>[
        ...
        "mail_to_address"=>[
             ...
             ["name"=>"舒全刚","addr"=>"645064175@qq.com"]
        ]
    ],
    /**
     * -----------------------------
